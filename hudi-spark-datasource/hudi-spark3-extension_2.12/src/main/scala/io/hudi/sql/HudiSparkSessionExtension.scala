...
import org.apache.spark.sql.catalyst.analysis.{HudiAnalysis, HudiOperationsCheck, ProcessHudiMerge}
import org.apache.spark.sql.catalyst.optimizer.RewriteHudiUID
 ...
 *   .appName("...")
 *   .master("...")
 *   .config("spark.sql.extensions", "io.hudi.sql.HudiSparkSessionExtension")
 * }}}
 *
 */
